...
DEFAULT_PRESETS = [
    Preset(
        name="Podcast",
        description="Podcast/interview editing - preserve natural pauses",
        config=AnalysisConfig(
            ...
            post_pad_ms=150,
            merge_gap_ms=150,
            keep_short_pauses_ms=120,
            breath_detection=False,
        ),
    ),
    Preset(
        name="Tutorial",
        description="Tutorial/screencast - tighter cuts",
        config=AnalysisConfig(
            ...
            post_pad_ms=100,
            merge_gap_ms=100,
            keep_short_pauses_ms=80,
            breath_detection=True,
        ),
    ),
    Preset(
        name="Meeting",
        description="Meeting recording - aggressive silence removal",
        config=AnalysisConfig(
    ...
    Preset(
        name="Noisy Room",
        description="High background noise - use VAD",
        config=AnalysisConfig(
    ...
    Preset(
        name="Aggressive",
        description="Maximum silence removal - tight edits",
        config=AnalysisConfig(
            silence_threshold_db=-40.0,
            silence_min_duration_ms=150,
            pre_pad_ms=50,
            post_pad_ms=80,
            merge_gap_ms=80,
            keep_short_pauses_ms=0,
